  ...
  return (
    <div style={{ maxWidth: "900px", margin: "0 auto", padding: "20px", fontFamily: "Arial, sans-serif" }}>
      ...
      <div style={{ textAlign: "right", marginBottom: "20px" }}>
        <button style={{ ...buttonStyle, backgroundColor: "#f44336", color: "#fff" }} onClick={handleLogout}>로그아웃</button>
      </div>

      {/* 상단 년/월 페이징 */}
      <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: "10px", marginBottom: "20px" }}>
        <button style={{ ...buttonStyle, backgroundColor: "#2196F3", color: "#fff" }} onClick={() => moveMonth(-1)}>◀ 이전달</button>
        <strong style={{ fontSize: "18px" }}>{yearMonth}</strong>
        <button style={{ ...buttonStyle, backgroundColor: "#2196F3", color: "#fff" }} onClick={() => moveMonth(1)}>다음달 ▶</button>
      </div>
